# defmodule HtmlSanitizeExScrubberCustomConfigTest do
#   use ExUnit.Case

#   defp custom_config_sanitize(text) do
#     HtmlSanitizeEx.custom_config(text)
#   end
...
#     assert expected == custom_config_sanitize(input)
#   end
...
#     assert "" == custom_config_sanitize("")
#     assert "" == custom_config_sanitize("  ")
#     assert "" == custom_config_sanitize(nil)
#   end
...
#     assert "" == custom_config_sanitize("<a<a")
#   end

#   test "test_strip_links_with_plaintext" do
#     assert "Dont touch me" == custom_config_sanitize("Dont touch me")
#   end
...
#              custom_config_sanitize(
#                "<a href='almost'>My mind</a>\n<A href='almost'>all <b>day</b> long</A>"
#              )
#   end

#   @tag href_scrubbing: true
#   test "strips tags with custom_config_sanitize/1" do
#     input =
...
#       assert expected == custom_config_sanitize(x)
#     end)
#   end
...
#              custom_config_sanitize("<a href=\"http&#x3a;//legit\">")
...
#   #  assert ~s(<video src="videofile.ogg"></video>) == custom_config_sanitize("<video src=\"videofile.ogg\" poster=javascript:alert(1)></video>")
#   # end
...
#     assert "alert(\"XSS\")" ==
#              custom_config_sanitize("<SCR\0IPT>alert(\"XSS\")</SCR\0IPT>")
#   end

#   test "should_sanitize_invalid_script_tag" do
#     input = "<SCRIPT/XSS SRC=\"http://ha.ckers.org/xss.js\"></SCRIPT>"
#     assert "" == custom_config_sanitize(input)
#   end
...
#     assert "<img />" == custom_config_sanitize(input)
#   end
...
#     assert "<img />)\n" == custom_config_sanitize(img_hack)
#   end
...
#     assert "<span>blah</span>" == custom_config_sanitize(input)
#   end
...
#     assert "<img />" ==
#              custom_config_sanitize("<img/src=\"http://ha.ckers.org/xss.js\"/>")
#   end
...
#     assert "<img />" ==
#              custom_config_sanitize("<img src='vbscript:msgbox(\"XSS\")' />")
#   end

#   @tag cdata: true
#   test "should_sanitize_cdata_section" do
#     assert "<span>section</span>]]&gt;" ==
#              custom_config_sanitize("<![CDATA[<span>section</span>]]>")
#   end

#   @tag cdata: true
#   test "should_sanitize_cdata_section like any other" do
#     assert "section]]&gt;" ==
#              custom_config_sanitize("<![CDATA[<script>section</script>]]>")
#   end

#   @tag cdata: true
#   test "should_sanitize_unterminated_cdata_section" do
#     assert "<span>neverending...</span>" ==
#              custom_config_sanitize("<![CDATA[<span>neverending...")
#   end
...
#     assert input == custom_config_sanitize(input)
#   end
...
#     assert "<a>text here</a>" == custom_config_sanitize(input)
#   end
...
#     assert "<span></span>" == custom_config_sanitize("<span class=\"\\")
#   end
